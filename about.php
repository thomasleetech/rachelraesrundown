...
<div class="wrap" style="max-width:760px;padding:56px 36px;">
  ...
  <p style="font-size:17px;line-height:1.8;margin-bottom:18px;font-family:'EB Garamond',serif;">
  ...
  <div style="margin-top:32px;padding:20px;border:1px solid var(--light-gray);">
    <div style="font-family:'DM Mono',monospace;font-size:10px;letter-spacing:0.14em;color:var(--warm-gray);text-transform:uppercase;margin-bottom:12px;">Contact</div>
    <div style="font-family:'EB Garamond',serif;font-size:15px;line-height:2;color:var(--charcoal);">
      Tips: <a href="mailto:<?= siteMail('tips') ?>" style="color:var(--teal);"><?= siteMail('tips') ?></a><br>
      Letters: <a href="mailto:<?= siteMail('letters') ?>" style="color:var(--teal);"><?= siteMail('letters') ?></a><br>
      Legal (good luck): <a href="mailto:<?= siteMail('legal') ?>" style="color:var(--teal);"><?= siteMail('legal') ?></a><br>
      Emotional support: <a href="mailto:<?= siteMail('therapy') ?>" style="color:var(--teal);"><?= siteMail('therapy') ?></a>
    </div>
  </div>
